...
//  Festyvent
//
//  Created by Dejan Atanasov on 9/2/14.
//  Copyright (c) 2014 CLARIFi Media. All rights reserved.
//

#import "FBPhotoLayout.h"

@interface FBPhotoLayout()
@property (nonatomic, strong) NSDictionary *layoutInfo;
@end

@implementation FBPhotoLayout
static NSString * const GalerijaCellKind = @"PhotoCell";
...
- (void)prepareLayout
{
    ...
    newLayoutInfo[GalerijaCellKind] = cellLayoutInfo;
...
{
    return self.layoutInfo[GalerijaCellKind][indexPath];
}
